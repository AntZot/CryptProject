...
public class Const {
    ...
    public static final String BAGS_TABLE = "bags";
    public static final String BAG_NAME = "name";
    public static final String BAG_PROFIT = "profit";
    public static final String BAG_USERS_MAIL = "users_mail";
    public static final String BAG_ID = "id";

    public static final String BAGS_CONTENT_TABLE = "bags_content";
